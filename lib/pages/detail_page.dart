                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage("https://ostweg.github.io/${detailState.listing.image}"), fit: BoxFit.cover),
                      ),
                    )),
                Positioned(
                    left: 20,
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              TextTitle(
                                  text: "CHF "+detailState.listing.pricerperhour.toString()+"/hour", color: const Color(0xFF4c8bfc))
                            ],
                          ),
                          SizedBox(height: 10),
                          Row(
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 10),
                              TextDescription(
                                text: "("+detailState.listing.stars.toString()+")",
                                color: const Color(0xFF4c8bfc).withOpacity(0.6),
                                size: 13,
                              )
                            ],
